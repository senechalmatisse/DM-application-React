...
// Mutation pour créer un todo avec du texte donné dans une liste de tâches spécifique.
const CREATE_TODO = `
...
// Query pour obtenir la liste des todos dans une liste de tâches spécifique.
const TODOS = `
...
// Fonction pour récupérer la liste des todos à partir d'une liste de tâches spécifique.
...
// Mutation pour mettre à jour le statut "done" d'un todo spécifique.
const UPDATE_TODO = `
...
// Fonction pour mettre à jour le statut "done" d'un todo spécifique.
...
// Mutation pour supprimer un todo spécifique par son ID.
const DELETE_TODO = `
mutation($id: ID!) {
...
// Fonction pour supprimer un todo spécifique par son ID.
